...
## Using CosmJS (JavaScript & TypeScript)[​](https://docs.cosmos.network/main/run-node/txs#using-cosmjs-javascript--typescript "Direct link to Using CosmJS (JavaScript & TypeScript)")
